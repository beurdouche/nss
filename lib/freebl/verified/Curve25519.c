...
Hacl_Bignum_Fproduct_copy_from_wide_(uint64_t *output, FStar_UInt128_t *input)
{
    ...
    {
        FStar_UInt128_t uu____389 = input[3];
        uint64_t uu____388 = FStar_Int_Cast_uint128_to_uint64(uu____389);
        output[3] = uu____388;
    }
    {
        FStar_UInt128_t uu____389 = input[4];
        uint64_t uu____388 = FStar_Int_Cast_uint128_to_uint64(uu____389);
        output[4] = uu____388;
    }
}
    ...
    uint64_t s)
{
    ...
    {
        FStar_UInt128_t uu____795 = output[3];
        uint64_t uu____798 = input[3];
        FStar_UInt128_t
            uu____794 = FStar_UInt128_add_mod(uu____795, FStar_UInt128_mul_wide(uu____798, s));
        output[3] = uu____794;
    }
    {
        FStar_UInt128_t uu____795 = output[4];
        uint64_t uu____798 = input[4];
        FStar_UInt128_t
            uu____794 = FStar_UInt128_add_mod(uu____795, FStar_UInt128_mul_wide(uu____798, s));
        output[4] = uu____794;
    }
...
inline static void
Hacl_Bignum_Fmul_fmul_(uint64_t *output, uint64_t *input, uint64_t *input2)
{
...
{
    {
        uint64_t uu____795 = a[0];
        uint64_t uu____798 = b[0];
        uint64_t uu____794 = uu____795 + uu____798;
        a[0] = uu____794;
    }
    {
        uint64_t uu____795 = a[1];
        uint64_t uu____798 = b[1];
        uint64_t uu____794 = uu____795 + uu____798;
        a[1] = uu____794;
    }
    {
        uint64_t uu____795 = a[2];
        uint64_t uu____798 = b[2];
        uint64_t uu____794 = uu____795 + uu____798;
        a[2] = uu____794;
    }
    {
        uint64_t uu____795 = a[3];
        uint64_t uu____798 = b[3];
        uint64_t uu____794 = uu____795 + uu____798;
        a[3] = uu____794;
    }
    {
        uint64_t uu____795 = a[4];
        uint64_t uu____798 = b[4];
        uint64_t uu____794 = uu____795 + uu____798;
        a[4] = uu____794;
    }
}
...
Hacl_Bignum_fdifference(uint64_t *a, uint64_t *b)
{
    ...
    {
        uint64_t uu____795 = a[0];
        uint64_t uu____798 = tmp[0];
        uint64_t uu____794 = uu____798 - uu____795;
        a[0] = uu____794;
    }
    {
        uint64_t uu____795 = a[1];
        uint64_t uu____798 = tmp[1];
        uint64_t uu____794 = uu____798 - uu____795;
        a[1] = uu____794;
    }
    {
        uint64_t uu____795 = a[2];
        uint64_t uu____798 = tmp[2];
        uint64_t uu____794 = uu____798 - uu____795;
        a[2] = uu____794;
    }
    {
        uint64_t uu____795 = a[3];
        uint64_t uu____798 = tmp[3];
        uint64_t uu____794 = uu____798 - uu____795;
        a[3] = uu____794;
    }
    {
        uint64_t uu____795 = a[4];
        uint64_t uu____798 = tmp[4];
        uint64_t uu____794 = uu____798 - uu____795;
        a[4] = uu____794;
    }
}
...
Hacl_Bignum_fscalar(uint64_t *output, uint64_t *b, uint64_t s)
{
    ...
    {
        uint64_t uu____389 = b[0];
        FStar_UInt128_t uu____388 = FStar_UInt128_mul_wide(uu____389, s);
        tmp[0] = uu____388;
    }
    {
        uint64_t uu____389 = b[1];
        FStar_UInt128_t uu____388 = FStar_UInt128_mul_wide(uu____389, s);
        tmp[1] = uu____388;
    }
    {
        uint64_t uu____389 = b[2];
        FStar_UInt128_t uu____388 = FStar_UInt128_mul_wide(uu____389, s);
        tmp[2] = uu____388;
    }
    {
        uint64_t uu____389 = b[3];
        FStar_UInt128_t uu____388 = FStar_UInt128_mul_wide(uu____389, s);
        tmp[3] = uu____388;
    }
    {
        uint64_t uu____389 = b[4];
        FStar_UInt128_t uu____388 = FStar_UInt128_mul_wide(uu____389, s);
        tmp[4] = uu____388;
    }
    Hacl_Bignum_Fproduct_carry_wide_(tmp);
...
void *
Curve25519_op_String_Access(FStar_HyperStack_mem h, uint8_t *b)
{
    return (void *)(uint8_t)0;
}

void
Curve25519_crypto_scalarmult(uint8_t *mypublic, const uint8_t *secret, const uint8_t *basepoint)
{
    Hacl_EC_crypto_scalarmult(mypublic, (uint8_t *)secret, (uint8_t *)basepoint);
    return;
}
