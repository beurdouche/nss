...
void *Curve25519_op_String_Access(FStar_HyperStack_mem h, uint8_t *b)
{
  return (void *)(uint8_t )0;
}

void Curve25519_crypto_scalarmult(uint8_t *mypublic, const uint8_t *secret, const uint8_t *basepoint)
{
