...
static inline void
print128(unsigned char *where, uint128_t n)
{
...
static inline uint128_t
FStar_UInt128_split51(uint128_t *src)
{
...
static inline void
print128_(unsigned char *where, uint128_t *n)
{
    printf("%s: [%" PRIu64 ",%" PRIu64 "]\n", where, n->high, n->low);
}
...
static inline void
FStar_UInt128_add_(uint128_t *x, uint128_t *y, uint128_t *r)
{
    r->low = x->low + y->low;
...
static inline void
FStar_UInt128_add_mod_(uint128_t *x, uint128_t *y, uint128_t *r)
{
    FStar_UInt128_add_(x, y, r);
}

static inline void
FStar_UInt128_split51_(uint128_t *src, uint128_t *y)
{
    uint128_t x;
...
static inline void
FStar_UInt128_sub_(uint128_t *x, uint128_t *y, uint128_t *r)
{
    r->low = x->low - y->low;
...
static inline void
FStar_UInt128_sub_mod_(uint128_t *x, uint128_t *y, uint128_t *r)
{
    FStar_UInt128_sub_(x, y, r);
}

static inline void
FStar_UInt128_logand_(uint128_t *x, uint128_t *y, uint128_t *r)
{
...
static inline void
FStar_UInt128_logor_(uint128_t *x, uint128_t *y, uint128_t *r)
{
    r->high = x->high | y->high;
    r->low = x->low | y->low;
}
...
static inline void
FStar_UInt128_logxor_(uint128_t *x, uint128_t *y, uint128_t *r)
{
    r->high = x->high ^ y->high;
    r->low = x->low ^ y->low;
}
...
static inline void
FStar_UInt128_lognot_(uint128_t *x, uint128_t *r)
{
    r->high = ~x->high;
    r->low = ~x->low;
}
...
static inline void
FStar_UInt128_shift_left_(uint128_t *x, FStar_UInt32_t y, uint128_t *r)
{
    if (y < 64) {
...
/* y should not be a secret; y >= 128 should never happen */
static inline void
FStar_UInt128_shift_right_(uint128_t *x, FStar_UInt32_t y, uint128_t *r)
{
    if (y < 64) {
        r->high = (x->high >> y);
...
/* Conversions */
static inline void
FStar_Int_Cast_uint64_to_uint128_(uint64_t x, uint128_t *r)
{
    r->high = 0;
    r->low = x;
}
...
static inline uint64_t
FStar_Int_Cast_uint128_to_uint64_(uint128_t *x)
{
    return x->low;
}

static inline void
FStar_UInt128_eq_mask_(uint128_t *x, uint128_t *y, uint128_t *r)
{
    uint64_t mask =
...
static inline void
FStar_UInt128_gte_mask_(uint128_t *x, uint128_t *y, uint128_t *r)
{
...
static inline void
FStar_UInt128_mul_wide_(uint64_t x, uint64_t y, uint128_t *r)
{
...
static inline void
FStar_UInt128_mul32_(uint64_t x, uint32_t y, uint128_t *r)
{
...
static inline uint128_t
FStar_UInt128_shift_left(uint128_t x,
                         FStar_UInt32_t y)
{
    uint128_t r;
...
static inline uint128_t
FStar_UInt128_shift_right(uint128_t x,
                          FStar_UInt32_t y)
{
    uint128_t r;
...
/* Conversions */
static inline uint128_t
FStar_Int_Cast_uint64_to_uint128(uint64_t x)
{
    uint128_t r;
...
static inline uint64_t
FStar_Int_Cast_uint128_to_uint64(uint128_t x)
{
